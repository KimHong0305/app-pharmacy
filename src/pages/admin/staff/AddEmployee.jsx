...
import { createEmployee } from '../../../store/Reducers/userReducer';
...
const AddEmployee = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        formData.append("createEmployee", new Blob([JSON.stringify(employeeData)], { type: "application/json" }));
        ...
        <div className="px-2 md:px-4">
            <div className="p-4 rounded bg-white shadow-lg">
                <div className="min-h-96">
                    ...
                    <div className='py-5'>
                        <h2 className="text-center text-2xl font-bold mb-2">Thêm tài khoản</h2>
